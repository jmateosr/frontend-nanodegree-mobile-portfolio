...
*/
  function changePizzaSizes(size) {
    ...
    var elemPizza = document.getElementsByClassName("randomPizzaContainer");
    for (var i = 0; i < elemPizza.length; i++) {
      elemPizza[i].style.width = newwidth;
    }
  }
...
/* IMPROVEMENTS:
- Moved the scrollTop calculation outside the loop.
- Replaced the querySelectorAll with getElementsByClassName, which is faster
*/
